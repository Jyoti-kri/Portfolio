...
export default function Nav() {
  ...
  const socialLinks = [
    { icon: <FaGithub size={22} />, href: "https://github.com/Jyoti-kri", label: "GitHub" },
    { icon: <FaLinkedin size={22} />, href: "https://www.linkedin.com/in/jyoti-kumari-9850ba256/", label: "LinkedIn" },
