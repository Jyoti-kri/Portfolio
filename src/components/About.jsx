...
export default function About() {
  ...
  { 
    ...
    description: "Crafting responsive and user-friendly interfaces using HTML, CSS, JavaScript, React, and Tailwind CSS."
  },
  { 
    icon: <FaServer />, 
    title: "Backend Development", 
    description: "Developing robust backend applications and RESTful APIs using Node.js, Express.js, and JWT authentication."
  },
  { 
    icon: <FaDatabase />, 
    title: "Database Management", 
    description: "Managing data effectively with MongoDB and MySQL, integrating them into full-stack applications."
  },
  { 
    icon: <FaTools />, 
    title: "Developer Tools", 
    description: "Proficient in using Git, GitHub, and Postman for version control, collaboration, and API testing."
  }
];
