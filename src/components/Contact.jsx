...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://getform.io/f/axoyndmb", {
        method: "POST",
        body: formData,
        headers: {
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:jyoti628627@gmail.com" className="text-neutral-400 hover:text-indigo-400 transition-colors">jyoti628627@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-400">Kolkata, India</p>
                </div>
              </div>
            </div>
